...
public class ListingUserFeedCategoryBean {
	...
	public ListingUserFeedCategoryBean() {}
	
	public ListingUserFeedCategoryBean(ListingUserFeedCategoryBean bean) {
		
		setUser(bean.getUser());
		setCategory1(bean.getCategory1());
		setCategory2(bean.getCategory2());
		setCategory3(bean.getCategory3());
		setCategory4(bean.getCategory4());
		setNumberCategory1(bean.getNumberCategory1());
		setNumberCategory2(bean.getNumberCategory2());
		setNumberCategory3(bean.getNumberCategory3());
		setNumberCategory4(bean.getNumberCategory4());
		setMinPrice(bean.getMinPrice());
		setMaxPrice(bean.getMaxPrice());
		setExchange(bean.getExchange());
